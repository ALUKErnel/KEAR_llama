...
LastEditors: zrk
LastEditTime: 2024-07-29 17:47:17
'''
import openai
import jsonlines
import os
...
fh = logging.FileHandler(os.path.join(opt.save_file, 'log_politics_p5_temperature{}_translated_zero-shot_{}_{}_2.txt'.format(opt.temperature, opt.index1, opt.index2)))
log.addHandler(fh)
...
def form_template_label(test_data):
    ...
    for data in test_data:
        ...
        # prompt_template = "La position de " + comment + " envers " + question + " est? Give me a one-word answer. Select from 'Favor' and 'Against'."
        # p5
        prompt_template = "La position de " + comment + " envers " + question + " est [MASK]. You can translate TEXT into English and determine the stance next. Give me a one-word answer for stance prediction. Select from 'Favor' and 'Against'."
