...
LastEditors: zrk
LastEditTime: 2024-03-30 23:57:30
'''
import openai
import jsonlines
import os
...
fh = logging.FileHandler(os.path.join(opt.save_file, 'log_politics_p5_0_temperature0.1.txt'))
log.addHandler(fh)
...
def form_template_label(test_data):
    ...
    for data in test_data:
        ...
        # prompt_template = "La position de " + comment + " envers " + question + " est? Give me a one-word answer. Select from 'Favor' and 'Against'."
        # p5
        prompt_template = "La position de " + comment + " envers " + question + " est [MASK]. Select a one-word answer from 'Favor' and 'Against'."
