...
def writeout(file_path, data, header):
...
def convert_dataset_to_data(dataset):
    ...
    for i in range(len(dataset)):
        x, y = dataset[i]
        question, comment = x 
        data.append([question, comment, y])
...
if __name__ == "__main__":
    ...
    fr_test_data = convert_dataset_to_data(fr_test)
    writeout("dataset/translated_test.csv", fr_test_data, ["question", "comment", "label"])
    print("end")
